...
>>>>>>> 978004234d288764ebd12ba3f825d4e46b0daa99:backend/ORM/BL.py
        orm = ORM()
...
>>>>>>> 978004234d288764ebd12ba3f825d4e46b0daa99:backend/ORM/BL.py
    ...
    def addAsset(self,asset):
        ...
        assetId = orm.insert(
            Asset(shortName=asset["openpipe_canonical_title"][0], uri='', IdAtSource=asset["openpipe_canonical_id"][0], sourceId=self.sourceTable[asset['openpipe_canonical_source'][0]], metaDataId=asset["metaDataId"],
                  scope=0))
        results = []
        print(asset)
...
<<<<<<< HEAD:backend/WSGI/ORM/BL.py
    def getAllLayouts(self):
        result = []
        orm = ORM()
        queryStatement = "select * from collection where layoutType is not null"
        results = orm.executeSelect(queryStatement, ())
        return results
=======
